...
def get_data_loaders(
    ...
    data_transforms = {
        "train": transforms.Compose([   # YOUR CODE HERE
        ...
        "valid": transforms.Compose([   # YOUR CODE HERE
                                    transforms.Resize(256),
                                    transforms.CenterCrop(224),
                                    transforms.ToTensor(),
                                    transforms.Normalize(mean, std)
                                    ]),
        "test": transforms.Compose([ # YOUR CODE HERE
                                    transforms.Resize(256),
                                    transforms.CenterCrop(224),
                                    transforms.ToTensor(),
                                    transforms.Normalize(mean, std)
    ...
    train_data = datasets.ImageFolder(
        base_path / "train",
        transform=data_transforms["train"] # YOUR CODE HERE: add the appropriate transform that you defined in
    ...
    valid_data = datasets.ImageFolder(
        base_path / "train",
        transform=data_transforms["valid"] # YOUR CODE HERE: add the appropriate transform that you defined in
                                           # the data_transforms dictionary
    )
    ...
    test_data = datasets.ImageFolder(
        base_path / "test",
        transform=data_transforms["test"] # YOUR CODE HERE (add the test transform)
    )
    ...
    data_loaders["test"] = torch.utils.data.DataLoader(
        test_data, batch_size=batch_size, shuffle=False, num_workers=num_workers, sampler=test_sampler # YOUR CODE HERE (remember to add shuffle=False as well)
    )
